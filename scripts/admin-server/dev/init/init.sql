...
VALUES
    ...
    -- 6
    (4, 6, '꼭 예약하고 가세요~ 고생했습니다.', '2024-05-06', 4),
    -- 7
    (1, 6, '페이지네이션 용 리뷰', '2024-05-06', 2),
    (2, 6, '페이지네이션 용 리뷰', '2024-05-06', 3),
    (3, 6, '페이지네이션 용 리뷰', '2024-05-06', 1),
    (4, 6, '페이지네이션 용 리뷰', '2024-05-06', 4),
    (4, 6, '페이지네이션 용 리뷰', '2024-05-06', 3),
    (4, 6, '페이지네이션 용 리뷰', '2024-05-06', 3),
    (4, 6, '페이지네이션 용 리뷰', '2024-05-06', 3),
    (4, 6, '페이지네이션 용 리뷰', '2024-05-06', 3),
    (4, 6, '페이지네이션 용 리뷰', '2024-05-06', 3),
