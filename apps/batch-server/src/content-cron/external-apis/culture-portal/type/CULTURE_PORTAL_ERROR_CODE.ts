 ...
 * @author jochongs
 *
 * @link https://www.culture.go.kr/industry/apiGuideA.do - 에러코드
 */
export const CULTURE_PORTAL_ERROR_CODE = {
  '00': 'NORMAL SERVICE',
...
export type CulturePortalErrorCode =
  (typeof CULTURE_PORTAL_ERROR_CODE)[keyof typeof CULTURE_PORTAL_ERROR_CODE];
