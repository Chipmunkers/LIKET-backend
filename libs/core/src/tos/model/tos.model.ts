...
export class TosModel {
  ...
  constructor(data: TosModel) {
    Object.assign(this, data);
  }

  public static fromPrisma(tos: TosSelectField): TosModel {
    return new TosModel({
      idx: tos.idx,
      title: tos.title,
      contents: tos.contents,
